...
document.addEventListener('keydown', (e) => {
    ...
    if (konamiCode.join(',') === konamiSequence.join(',')) {
        ...
        setTimeout(() => {
            ...
            alert('🎉 Easter egg found! Selamat, kamu menemukan kode rahasia KKN Lintang! 🎉');
        }, 2000);
        konamiCode = [];
    }
});
...
console.log('🏝️ Website KKN Lintang loaded successfully! 🏝️');
console.log('Made with ❤️ for the memories of Desa Lintang, Belitung Timur');
